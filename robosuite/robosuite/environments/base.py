...
class MujocoEnv(metaclass=EnvMeta):
    ...
    def _reset_internal(self):
        ...
        if self.has_offscreen_renderer:
            print("self.sim._render_context_offscreen is None _reset_internal ", self.sim._render_context_offscreen)
            if self.sim._render_context_offscreen is None:
                render_context = MjRenderContextOffscreen(self.sim, device_id=self.render_gpu_device_id)
            print("self.render_collision_mesh=", self.render_collision_mesh, " self.render_visual_mesh=", self.render_visual_mesh)
